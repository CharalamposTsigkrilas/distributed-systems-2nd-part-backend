...
public class InitialDataService {
    ...
    private void createDoctors() {
        ...
        if (doctorRepository.count() == 0) {
            ...
            Doctor doctor1 = new Doctor("Iwannis Athanasiadis", "doctor1", passwordEncoder.encode("1234"),
                    "gatha@gmail.com", "2100000123", "Sterea Ellada", "Attiki", "Kardiologos", "Davaki 11, Kallithea");
            Doctor doctor2 = new Doctor("Giorgos Alexopoulos", "doctor2", passwordEncoder.encode("1234"),
                    "galexop@gmail.com", "2100000321", "Sterea Ellada", "Evia", "Pathologos",
                    "Makri Ippokratis 35, Nea Artaki Evia");
            Doctor doctor3 = new Doctor("Hrw Alexandrou", "doctor3", passwordEncoder.encode("1234"),
                    "halexandrou@gmail.com", "2100000333", "Kriti", "Xania", "Kardiologos",
                    "Ethnikis Antistaseos, Neapoli Lasithiou");
            Doctor doctor4 = new Doctor("Mhltos Anastasiou", "doctor4", passwordEncoder.encode("1234"),
                    "manastasiou@gmail.com", "2100000222", "Makedonia", "Thessaloniki", "Orila",
                    "Loutron 35, Lagadas Thessaloniki");
            Doctor doctor5 = new Doctor("Nikoleta Ioannou", "doctor5", passwordEncoder.encode("1234"),
                    "nioanou@gmail.com", "2100000111", "Makedonia", "Kavala", "Odontiatros",
                    "Papachristidis Fr. 119, Eleftheroupolis Kavala");
    ...
    private void createCitizens() {
        ...
        if (citizenRepository.count() == 0) {
            ...
            Citizen citizen1 = new Citizen("Kyriakos Antoniadis", "citizen1", passwordEncoder.encode("1234"),
                    "kanto@gmail.com", "2101230000", "Sterea Ellada", "Attiki", "20050301234", "Tompra 3");
            Citizen citizen2 = new Citizen("Nikolas Zafeiriadis", "citizen2", passwordEncoder.encode("1234"),
                    "nzafeiriadis@gmail.com", "2103210000", "Sterea Ellada", "Viotia", "20059001234", "Kosmitorou 23");
            Citizen citizen3 = new Citizen("Kwnstantinos Pappadopoulos", "citizen3", passwordEncoder.encode("1234"),
                    "kwstaspap@gmail.com", "2103212000", "Kriti", "Xania", "21089901234", "25hs Martiou 34");
            Citizen citizen4 = new Citizen("Mery Politou", "citizen4", passwordEncoder.encode("1234"),
                    "merypolitou@gmail.com", "2103213000", "Makedonia", "Thessaloniki", "21079501234", "Skoufa 5");
            Citizen citizen5 = new Citizen("Gwgw Georgiou", "citizen5", passwordEncoder.encode("1234"),
                    "gwgwgeorgiou@gmail.com", "2103214000", "Makedonia", "Thessaloniki", "20050101234", "Kallirois 4");
