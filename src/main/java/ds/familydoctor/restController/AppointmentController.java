package ds.familydoctor.restController;

import ds.familydoctor.entity.*;
import ds.familydoctor.payload.response.MessageResponse;
import ds.familydoctor.service.*;
...
public class AppointmentController {
    ...
    public ResponseEntity<?> saveAppointment(@RequestBody Appointment appointment, @PathVariable Long familyMember_id) {
        ...
        if (familyMemberService.getFamilyMemberAppointment(familyMember_id) != null) {
            if ((appointment.getCurrentStatus().equals(Appointment.status.Set.toString()) ||
                ...
                return ResponseEntity.badRequest()
                        .body(new MessageResponse("Error: Family Member has already an active Appointment!"));
            }
        }
        ...
        if (doctor == null) {
            return ResponseEntity.badRequest()
                    .body(new MessageResponse("Error: Family of this Member doesn't have a family doctor!"));
        }
    ...
    public ResponseEntity<?> editAppointment(@Valid @RequestBody Appointment appointment,
        ...
        if (appointment.getCurrentStatus().equals(Appointment.status.Completed.toString())) {
            return ResponseEntity.badRequest()
                    .body(new MessageResponse("Error: Completed appointment cannot be changed!"));
        }
        if (appointment.getCurrentStatus().equals(Appointment.status.Canceled.toString())) {
            return ResponseEntity.badRequest()
                    .body(new MessageResponse("Error: Canceled appointment cannot be changed!"));
        }
    ...
    public ResponseEntity<?> completedAppointment(@RequestBody int appointmentGrade,
            @PathVariable Long appointment_id) {
        ...
        if (appointment.getCurrentStatus().equals(Appointment.status.Completed.toString())) {
            return ResponseEntity.badRequest()
                    .body(new MessageResponse("Error: Appointment has already been completed!"));
        }
        if (appointment.getCurrentStatus().equals(Appointment.status.Canceled.toString())) {
            return ResponseEntity.badRequest()
                    .body(new MessageResponse("Error: Canceled appointment cannot be completed!"));
        }
    ...
    public ResponseEntity<?> canceledAppointment(@PathVariable Long appointment_id) {
        ...
        if (appointment.getCurrentStatus().equals(Appointment.status.Completed.toString())) {
            return ResponseEntity.badRequest()
                    .body(new MessageResponse("Error: Completed Appointment cannot be canceled!"));
        }
        if (appointment.getCurrentStatus().equals(Appointment.status.Canceled.toString())) {
            return ResponseEntity.badRequest()
                    .body(new MessageResponse("Error: Appointment has already been canceled!"));
        }
