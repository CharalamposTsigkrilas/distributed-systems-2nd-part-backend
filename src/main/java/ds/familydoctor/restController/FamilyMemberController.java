...
public class FamilyMemberController {
    ...
    public ResponseEntity<?> saveFamilyMember(@Valid @RequestBody FamilyMember familyMember,
            @PathVariable Long citizen_id) {
    ...
    public ResponseEntity<?> editFamilyMember(@RequestBody FamilyMember updatedFamilyMember,
            @PathVariable Long familyMember_id) {
        ...
        if (familyMemberCitizen == null) {
            return ResponseEntity.badRequest()
                    .body(new MessageResponse("Error: Citizen of this family member not found!"));
        }
    ...
    public ResponseEntity<?> deleteFamilyMember(@PathVariable Long familyMember_id) {
        ...
        if (citizenAMKA.equals(fmAMKA)) {
            return ResponseEntity.badRequest()
                    .body(new MessageResponse("Error: You cannot delete the main Family Member!"));
        }
